...
foreach($productos as $key => $value){
  ...
  echo '<tr>
    <td>'.($key+1).'</td>
    <td><img src="views/img/productos/default/anonymous.png" width="40px" class="img-thumbnail"></td>
    <td>'.$value["codigo"].'</td>
    ...
    <td>
      <div class="btn-group">
        <button class="btn btn-warning btn-xs" type="button"><i class="fa fa-pencil"></i></button>
        <button class="btn btn-danger btn-xs" type="button"><i class="fa fa-times"></i></button>
      </div>
    </td>
    </tr>
  ';
